...
insert into producto(pro_tipo,pro_nombre,pro_costo,pro_unid,pro_pv) values('Alimento','Chunky cordero 12kg',87632,10,100777);
...
insert into mascota(mas_nombre,mas_tipo,mas_raza,mas_peso,mas_sexo,mas_tamano,mas_des_social,mas_edad,mas_dueno) values('Tony','Perro','Criollo',388.88,'m',42,'Miedoso, fue recogido de la calle',NULL,7);
...
insert into mascota(mas_nombre,mas_tipo,mas_raza,mas_peso,mas_sexo,mas_tamano,mas_des_social,mas_edad,mas_dueno) values('Princesa','Perro','Baset hound',33,'h',32,'Perezoso',3.25,7);
...
insert into mascota(mas_nombre,mas_tipo,mas_raza,mas_peso,mas_sexo,mas_tamano,mas_des_social,mas_edad,mas_dueno) values('Niña','Perro','Criollo',17,'h',32,'Juguetón',3,1);
...
insert into factura(mas_id,emp_id,ser_id, fact_costo) values(100, 4, 'V', 50000);
